...
const ERROR_MESSAGES: Record<string, string> = {
  not_allowed: "このメールアドレスは運営コンソールのアクセス権がありません。",
  invalid_code:
    "ログインリンクが無効か期限切れです。再度メールを送信してください。",
};
      ...
      <div className="w-full max-w-md">
        <div className="bg-surface border border-rule-strong">
          <header className="px-8 pt-8 pb-5 border-b border-rule">
            <p className="font-[family-name:var(--font-mono)] text-[10px] uppercase tracking-[0.18em] text-subtle mb-2">
              super-admin
            </p>
